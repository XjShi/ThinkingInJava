...
public class Tester<C> {
    ...
    public static <C> void run(C cntnc, List<Test<C>> tests) {
        new Tester<C>(cntnc, tests).timedTest();
    }

    public static <C> void run(C cntnc, List<Test<C>> tests, TestParam[] paramList) {
        new Tester<C>(cntnc, tests, paramList).timedTest();
    }
